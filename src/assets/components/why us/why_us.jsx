    ...
    <>
      ...
      <section className="w-full py-20 font-sans relative overflow-hidden bg-grid-whyus" style={{ backgroundColor: '#050505', color: '#ffffff' }}>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 relative z-10 max-w-7xl mx-auto">
...
const Feature = ({ title, description, icon, index }) => {
  return (
    <div className={cn("flex flex-col lg:border-r py-10 relative group/feature border-neutral-800", (index === 0 || index === 4) && "lg:border-l border-neutral-800", index < 4 && "lg:border-b border-neutral-800")}>
      ...
      <div className="mb-4 relative z-10 px-4 lg:px-10 text-neutral-400">
        {icon}
      </div>
      <div className="text-lg font-bold mb-2 relative z-10 px-4 lg:px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-700 group-hover/feature:bg-blue-500 transition-all duration-200 origin-center" />
        <span className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-neutral-100">
          {title}
        </span>
      </div>
      <p className="text-sm text-neutral-300 max-w-xs relative z-10 px-4 lg:px-10">
        {description}
      </p>
    </div>
  );
